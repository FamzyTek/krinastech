    ...
    <div style={{ display:'flex', alignItems:'center', justifyContent:'center', minHeight:'100vh', background:'#0A0A0A' }}>
      <div style={{ background:'#141414', border:'1px solid #2A2A2A', borderTop:'2px solid #C9A84C', borderRadius:12, padding:'2.5rem 2rem', width:340 }}>
        <div style={{ textAlign:'center', marginBottom:'2rem' }}>
          <div style={{ width:58, height:58, background:'#1C1C1C', border:'1.5px solid #C9A84C', borderRadius:12, display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 12px', fontSize:28, color:'#C9A84C' }}>⚡</div>
          <h1 style={{ fontSize:20, fontWeight:700, color:'#C9A84C', letterSpacing:2 }}>KRINAS TECH</h1>
          <p style={{ fontSize:11, color:'#8A8070', letterSpacing:2, textTransform:'uppercase', marginTop:3 }}>Business Portal</p>
        </div>
        ...
        <p style={{ fontSize:11, color:'#8A8070', textAlign:'center', marginTop:12 }}>Admin: admin / krinas2024 | Staff: staff / staff123</p>
      </div>
    </div>
  )
}